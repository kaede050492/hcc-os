...
return function(E)
 ...
 function Setup:draw(c)
  ...
  if page=="Welcome" then c:paragraph(8,66,"Welcome to HCC OS v1.5.1. Existing files are preserved. This setup configures the modular Tom's GPU desktop.",P.textSecondary,c.w-16,6)
